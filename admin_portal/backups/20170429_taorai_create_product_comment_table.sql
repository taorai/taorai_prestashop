...
-- Dumping data for table db_taorai_dev.taorai_product_comments: ~0 rows (approximately)
/*!40000 ALTER TABLE `taorai_product_comments` DISABLE KEYS */;
INSERT INTO `taorai_product_comments` (`id_comment`, `id_product`, `id_customer`, `date_add`, `content`) VALUES
	(1, 4, 2, '2017-04-29 16:08:11', 'Good quality!');
