...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/international/translations')) {
            ...
            if (0 === strpos($pathinfo, '/international/translations/m')) {
                ...
                if ($pathinfo === '/international/translations/messages/fragments') {
                    if ($this->context->getMethod() != 'POST') {
                        $allow[] = 'POST';
                        goto not_admin_international_translations_messages_fragments;
                    }

                    return array (  '_controller' => 'PrestaShopBundle\\Controller\\Admin\\TranslationsController::messagesFragmentsAction',  '_route' => 'admin_international_translations_messages_fragments',);
                }
                not_admin_international_translations_messages_fragments:

            }

            if (0 === strpos($pathinfo, '/international/translations/e')) {
                // admin_international_translations_edit
                if ($pathinfo === '/international/translations/edit') {
                    if ($this->context->getMethod() != 'POST') {
                        $allow[] = 'POST';
                        goto not_admin_international_translations_edit;
                    }

                    return array (  '_controller' => 'PrestaShopBundle\\Controller\\Admin\\TranslationsController::editAction',  '_legacy_controller' => 'AdminTranslations',  '_route' => 'admin_international_translations_edit',);
                }
                not_admin_international_translations_edit:
